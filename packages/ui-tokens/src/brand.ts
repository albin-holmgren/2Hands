...
export const brandMark = {
  ...
  paths: [
    "M14 30.5C11.5 33 9.5 31.5 8.5 28C5.5 16 14.5 5 27.5 5H39C43.5 5 48 5.5 50 6.5C53.5 7.5 52 10 49 10H44C41.5 10 41.5 14 44 14H54C58 14 58 19 54 19H44C41.5 19 41.5 23 44 23H48C50 23 50 24.5 48 26L44.6 29.4Q44 30 43.15 30H31.9Q29 30 31.05 27.95L33.5 25.5C38 21 35 16.5 30.5 17C26.5 17.5 24 19.5 21 23L14 30.5Z",
    "M50 33.5C52.5 31 54.5 32.5 55.5 36C58.5 48 49.5 59 36.5 59H25C20.5 59 16 58.5 14 57.5C10.5 56.5 12 54 15 54H20C22.5 54 22.5 50 20 50H10C6 50 6 45 10 45H20C22.5 45 22.5 41 20 41H16C14 41 14 39.5 16 38L19.4 34.6Q20 34 20.85 34H32.1Q35 34 32.95 36.05L30.5 38.5C26 43 29 47.5 33.5 47C37.5 46.5 40 44.5 43 41L50 33.5Z",
  ],
  gradients: [
    {
      x1: 10,
