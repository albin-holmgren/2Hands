...
import { useEffect, useMemo, useRef, useState, useMemo as useThemeMemo } from "react";
import {
  ActivityIndicator,
  Alert,
  Linking,
...
const makeStyles = (native: NativeTheme) =>
  StyleSheet.create({
    ...
    remove: { color: native.danger, fontSize: 14, fontWeight: "600" },
    error: { color: native.danger, fontSize: 14 },
    advancedToggle: {
      marginTop: 8,
      minHeight: 44,
      flexDirection: "row",
