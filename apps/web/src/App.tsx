  ...
  return (
    ...
    >
      ...
      <main className="flex flex-1 flex-col">
        <div className="h-[74px] border-b border-[var(--rk-hairline)]" />
        <div className="flex flex-1 items-center justify-center text-[14px] text-[var(--rk-muted-2)]">
          <Trans>Opening your Space…</Trans>
        </div>
        <div className="mx-6 mb-6 h-[54px] rounded-full border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)]" />
      </main>
    </div>
  );
}
