    ...
    >
      <div className="flex items-center justify-between gap-4 border-b border-[var(--rk-hairline)] px-[18px] py-3.5">
        ...
        <button
          ...
          aria-label={t`Close`}
          onClick={onClose}
          className="rounded-[9px] px-3 py-1.5 text-[13.5px] text-[var(--rk-muted)] hover:bg-[var(--rk-surface-2)] hover:text-[var(--rk-ink)]"
        >
          <Trans>Close</Trans>
        </button>
      </div>
          ...
          {conversation.messages.map((peerMessage, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="mb-1 text-[12px] text-[var(--rk-muted)]" dir="auto">
      ...
      <div className="flex items-center justify-between gap-4 border-t border-[var(--rk-hairline)] px-[18px] py-3.5">
        ...
        <button
          type="button"
          onClick={onClose}
          className="rounded-[9px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] px-3.5 py-1.5 text-[13.5px] text-[var(--rk-ink)] hover:bg-[var(--rk-surface-2)]"
        >
          <Trans>Close</Trans>
        </button>
      </div>
