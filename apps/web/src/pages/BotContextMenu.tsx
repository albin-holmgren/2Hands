  ...
  return (
    <div className="fixed inset-0 z-40">
      ...
      <div
        ...
        className="fixed w-[264px] rounded-[18px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface-2)] p-2 shadow-[0_24px_60px_rgba(0,0,0,.62)]"
      ...
      {sectionMenuOpen ? (
        <div
          ...
          className="fixed max-h-[min(420px,calc(100vh-16px))] w-[264px] overflow-y-auto rounded-[18px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface-2)] p-2 shadow-[0_24px_60px_rgba(0,0,0,.62)]"
...
function MenuItem({
  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-3 rounded-[11px] px-3 py-2.5 text-start text-[15px] outline-none hover:bg-[var(--rk-surface-2)] focus-visible:bg-[var(--rk-surface-2)] ${
