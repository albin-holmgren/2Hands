  ...
  return (
    <div className="absolute inset-0 z-30 flex items-center justify-center rk-overlay-backdrop p-4 sm:p-10">
      <div className="flex h-[min(760px,100%)] w-[1080px] max-w-full flex-col overflow-hidden rounded-[26px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] shadow-[var(--rk-shadow-popover)]">
          ...
          <div>
            ...
            <p className="mt-1 text-[13.5px] text-[var(--rk-muted)]">
              {loading ? (
                ...
                <Trans>Choose which connected model 2hands uses.</Trans>
              )}
            </p>
          </div>
          <button
        ...
        <div className="mx-6 mt-5 rounded-[14px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] px-4 py-3 sm:mx-8">
              ...
              <>
                    ...
                    <>
                      <label className="block">
                        ...
                        <input
                          ...
                          autoComplete="off"
                          className="mt-2 w-full rounded-[11px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] px-3.5 py-3 text-[var(--rk-ink)] outline-none"
                        />
                      </label>
                        ...
                        {probeModels.length && probeModels.includes(modelId) ? (
                          <div className="relative mt-2">
                            <select
                              ...
                              className="w-full appearance-none rounded-[11px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] py-3 pl-3.5 pr-11 text-sm text-[var(--rk-ink)]"
                            >
                              {probeModels.map((id) => (
                ...
                {selected.auth === "oauth" && !subscriptionSignIn ? (
                  <p className="mt-5 text-sm leading-[1.5] text-[var(--rk-muted)]">
                    <Trans>
                      This subscription sign-in is not available in 2hands yet. Use a deployment
