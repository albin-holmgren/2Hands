...
export function PluginsOverlay({
  ...
  return (
    <div className="absolute inset-0 z-30 flex items-center justify-center bg-[rgba(4,4,5,.62)] p-10">
      <div className="flex h-[760px] w-[1080px] max-w-full flex-col overflow-hidden rounded-[26px] border border-[#232326] bg-[var(--rk-surface)] shadow-[0_40px_90px_rgba(0,0,0,.55)]">
                    ...
                    return (
                      ...
                      >
                        {item?.logo ? (
                          ...
                          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-[#2C2C30] text-sm font-semibold text-[var(--rk-ink)]">
                            {tile.label[0]}
                          </div>
                        )}
            ...
            <div className="mt-4 space-y-4">
              {onOpenMcp ? (
                <button
                  type="button"
                  onClick={onOpenMcp}
                  className="rounded-full border border-[#383844] px-3 py-1.5 text-xs text-[var(--rk-body)] hover:bg-[var(--rk-surface-2)]"
                >
              ...
              {sourceKind ? (
                <div className="space-y-3 rounded-[16px] border border-[#2C2C30] bg-[var(--rk-surface)] p-5">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-[#2C2C30] bg-[#171719] px-3 py-2.5 text-sm text-[var(--rk-ink)] outline-none"
                  />
                  {sourceKind !== "treg" ? (
                    <input
                      value={sourceUrl}
              ...
              <div>
                ...
                {sources.map((source) => (
                  ...
                  >
                    <div className="grid h-[42px] w-[42px] place-items-center rounded-xl bg-[#2C2C30] font-semibold uppercase text-[var(--rk-ink)]">
                      {source.kind === "mcp" ? "M" : "A"}
                    </div>
                    <div className="min-w-0 flex-1">
