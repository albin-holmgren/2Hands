...
export function PluginsOverlay({
  ...
  return (
    <div className="absolute inset-0 z-30 flex items-center justify-center rk-overlay-backdrop p-10">
      <div className="flex h-[760px] w-[1080px] max-w-full flex-col overflow-hidden rounded-[26px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] shadow-[var(--rk-shadow-popover)]">
        ...
        <div className="px-8 pt-4">
          <input
            ...
            className="w-full rounded-[13px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] px-4 py-3 text-[15px] text-[var(--rk-ink)] outline-none"
          />
        </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {disabled ? (
                            <div className="truncate text-[12.5px] text-[var(--rk-muted)]">
            ...
            <div className="mt-4 space-y-4">
              {onOpenMcp ? (
                <button
                  type="button"
                  onClick={onOpenMcp}
                  className="rounded-full border border-[var(--rk-hairline-strong)] px-3 py-1.5 text-xs text-[var(--rk-body)] hover:bg-[var(--rk-surface-2)]"
                >
              ...
              {sourceKind ? (
                <div className="space-y-3 rounded-[16px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] p-5">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface-2)] px-3 py-2.5 text-sm text-[var(--rk-ink)] outline-none"
                  />
                  {sourceKind !== "treg" ? (
                    <input
                      value={sourceUrl}
                  ...
                  <p className="text-xs leading-5 text-[var(--rk-muted)]">
                    <Trans>
                      2hands verifies the source before saving it. Credentials are encrypted and are
