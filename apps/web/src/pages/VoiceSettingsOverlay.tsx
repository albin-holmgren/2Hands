      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-6 overflow-hidden px-6 py-6 sm:px-8 md:flex-row">
          <div className="flex min-h-0 shrink-0 flex-col md:w-[280px]">
            ...
            <div className="rk-scroll overflow-y-auto rounded-[13px] border border-[var(--rk-hairline-strong)]">
              {catalog.map((entry) => {
              ...
              <>
                ...
                <label className="mt-5 block text-[13.5px] text-[var(--rk-muted)]">
                  ...
                  <input
                    ...
                    className="mt-2 w-full rounded-[11px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] px-3.5 py-2.5 text-[14px] text-[var(--rk-ink)] outline-none"
                  />
                </label>
                <Button
                  type="button"
