              ...
              {MEMORY_PROVIDER_SETTINGS.length > 1 ? (
                <label className="mb-4 block text-[13.5px] text-[var(--rk-muted)]">
                  ...
                  <select
                    ...
                    className="mt-2 w-full rounded-[11px] border border-[var(--rk-hairline-strong)] bg-[var(--rk-surface)] px-3.5 py-3 text-[var(--rk-ink)] outline-none disabled:opacity-40"
                  >
