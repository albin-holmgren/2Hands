  ...
  return (
    <div className="flex justify-start">
      <button
        ...
        onClick={onClick}
        className="inline-flex max-w-full items-center gap-1.5 rounded-full px-2.5 py-1 text-[13px] text-[var(--rk-muted)] transition-colors hover:bg-[var(--rk-surface-2)] hover:text-[var(--rk-body)]"
      >
