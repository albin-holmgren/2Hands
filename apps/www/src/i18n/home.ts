...
const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    ...
    ogImageAlt:
      "2hands — your AI models, projects, and work in one place.",
    ...
    hero: {
      badge: "Apache-2.0",
      pill: "Self-hosted",
      heading: "A workspace for work that gets done.",
      lead: "Research, browse, write, and build with AI. Switch models and projects, keep your context, and start with a recurring free allowance.",
    ...
    selfHost: {
      ...
      copy: "Run 2hands with your own models and infrastructure. Built on Rakazo, under the Apache-2.0 license.",
      ...
      features: [
        ...
        },
        {
          ...
          body: "Schedule repeat work, review the results, and pause or change a routine from desktop or mobile.",
        },
        {
    ...
    openSource: {
      eyebrow: "Open source",
      heading: "Hosted when you want. Self-hosted when you need.",
      copy: "2hands is Apache-2.0 licensed. Use hosted access with clear spending limits, or run the core product on your own infrastructure.",
      ...
      cloudTitle: "Cloud",
      cloudBadge: "Controlled preview",
      cloudMeta: "Free access, flexible models, one shared allowance",
      cloudItems: [
        "Computers start on demand and pause when idle",
        "BYOK available; hosted computer time uses your allowance",
    ...
    cta: {
      ...
      copy: "Give 2hands something you have been putting off and let it handle the follow-through.",
      getStarted: "Get started",
      viewOnGithub: "View on GitHub",
    ...
    getStartedDialog: {
      ...
      cloudHint: "Join the 2hands hosted preview.",
      back: "Back",
      successTitle: "You're in.",
      successCopy:
        "We'll email you when your hosted 2hands access is ready. Want to start today? Jump to Self-host on this page.",
      done: "Done",
      viewOnGithub: "View on GitHub",
    },
    waitlist: {
  ...
  de: {
    title: "2hands | Open-Source-Alternative zu Grok Bot",
    description:
      "2hands ist eine Open-Source-Alternative zu Grok Bot für persistente KI-Teamkollegen, die echte Arbeit erledigen. Deine Keys, dein Modell, deine Maschine.",
    ogImageAlt:
      "2hands — KI-Teamkollegen, die dir wirklich gehören. Deine Keys, dein Modell, deine Maschine.",
    ...
    hero: {
      ...
      lead: "2hands ist eine Open-Source-Alternative zu Grok Bot. Gib einem Bot echte Arbeit. Er meldet sich in deinen Tools an, nutzt sie wie du — und kommt zurück, wenn er dich braucht.",
      getStarted: "Loslegen",
      viewOnGithub: "Auf GitHub ansehen",
    ...
    selfHost: {
      ...
      copy: "Starte 2hands mit veröffentlichten Images. Lokale Docker-Computer laufen ohne E2B-Account.",
    ...
    openSource: {
      eyebrow: "Open Source",
      heading: "Open Source. Auch selbst gehostet.",
      copy: "Betreibe 2hands mit eigenen Modellen und eigener Infrastruktur. Auf Basis von Rakazo, unter der Apache-2.0-Lizenz.",
      selfHostTitle: "Self-host",
      ...
      selfHostItems: [
        ...
        "Optionales Hosting, eigene Infrastruktur",
        "Community-Support auf GitHub",
      ],
      starOnGithub: "Auf GitHub mit Stern markieren",
      readTheDocs: "Docs lesen",
      cloudTitle: "Cloud",
      cloudBadge: "Kontrollierte Vorschau",
      cloudMeta: "Kostenlos starten, Modelle flexibel wählen",
      cloudItems: [
        "Isolierte Computer nach Bedarf",
        "Gemeinsames Guthaben für Modelle und Computer; eigene Keys bleiben möglich",
    ...
    cta: {
      ...
      copy: "Gib 2hands etwas, das du aufgeschoben hast — und lass es den Follow-through übernehmen.",
      getStarted: "Loslegen",
      viewOnGithub: "Auf GitHub ansehen",
      openSourceValue: "Open Source",
      selfHostValue: "Self-host",
      stats: [
        ...
        { value: "openSource", label: "Apache-2.0" },
    ...
    getStartedDialog: {
      ...
      cloudHint: "Gehostetes 2hands kommt. Hinterlasse deine E-Mail.",
      back: "Zurück",
      successTitle: "Du bist dabei.",
      successCopy:
        "Wir mailen dir, wenn gehostetes 2hands bereit ist. Heute starten? Zum Self-host-Abschnitt auf dieser Seite.",
      done: "Fertig",
      viewOnGithub: "Auf GitHub ansehen",
    },
    waitlist: {
  ...
  ko: {
    title: "2hands | 오픈소스 Grok Bot 대안",
    description:
      "2hands는 실제 업무를 수행하는 지속형 AI 팀원을 위한 오픈소스 Grok Bot 대안입니다. 키, 모델, 머신 — 모두 당신 것.",
    ogImageAlt: "2hands — 진짜로 내 것인 AI 팀원. 키, 모델, 머신 — 모두 당신 것.",
    ...
    hero: {
      ...
      lead: "2hands는 오픈소스 Grok Bot 대안입니다. 봇에게 실제 업무를 맡기세요. 봇이 도구에 로그인하고, 당신처럼 사용하며, 필요할 때 돌아와 묻습니다.",
      getStarted: "시작하기",
      viewOnGithub: "GitHub에서 보기",
    ...
    selfHost: {
      eyebrow: "셀프 호스트",
      heading: "컴퓨터는 당신 것",
      copy: "게시된 이미지로 2hands를 실행하세요. 로컬 Docker 컴퓨터는 E2B 계정 없이 동작합니다.",
    ...
    openSource: {
      eyebrow: "오픈소스",
      heading: "오픈소스, 직접 호스팅도 가능",
      copy: "자신의 모델과 인프라로 2hands를 실행하세요. Rakazo를 기반으로 하며 Apache-2.0 라이선스를 사용합니다.",
      ...
      cloudTitle: "Cloud",
      cloudBadge: "제한된 미리보기",
      cloudMeta: "무료로 시작하고 모델을 선택하세요",
      cloudItems: [
        "필요할 때 사용하는 격리된 컴퓨터",
        "모델과 컴퓨터의 통합 사용 한도, 개인 API 키도 지원",
    ...
    cta: {
      heading: "첫 봇을 만나보세요",
      copy: "미뤄 두었던 일을 2hands에 맡기고, 후속까지 맡기세요.",
      getStarted: "시작하기",
      viewOnGithub: "GitHub에서 보기",
    ...
    getStartedDialog: {
      ...
      cloudHint: "호스팅 2hands가 곧 옵니다. 이메일을 남겨 주세요.",
      back: "뒤로",
      successTitle: "등록되었습니다.",
      successCopy:
        "호스팅 2hands가 준비되면 메일로 알려 드립니다. 오늘 시작하려면 이 페이지의 셀프 호스트 섹션으로 이동하세요.",
      done: "완료",
      viewOnGithub: "GitHub에서 보기",
    },
    waitlist: {
