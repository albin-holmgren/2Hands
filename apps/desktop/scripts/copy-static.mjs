...
await Promise.all([
  ...
  // Use the generated shared artwork, so setup never carries its own geometry.
  copyFile(
    path.resolve(root, "../web/public/brand/twohands-mark.svg"),
    path.join(dist, "twohands-mark.svg"),
  ),
]);
